...
def showHTML(img_data, msg):
    ...
    print(f"""
        ...
        <head>
            <meta charset="UTF-8">
            <title>Tiger Binary Classification</title>
            <style>
                body {{
        ...
        <body>
            <div class="container">
                <h1>Tiger Binary classification</h1>
...
# (2) 모델 로딩
if SCRIPT_MODE:
    pklfile_2 = os.path.abspath(r'C:\Users\PC\Desktop\AI_KDT6\KDT6\mini-project\cgi-bin\model\CNN_bc_custom_clf_model.pth')
